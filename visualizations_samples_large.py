...
from baselines.ViT.ViT_new import vit_large_patch16_224
from baselines.ViT.ViT_LRP import vit_large_patch16_224 as vit_LRP
from baselines.ViT.ViT_orig_LRP import vit_large_patch16_224 as vit_orig_LRP
...
if __name__ == "__main__":
    ...
    plt.savefig('dog_cat_sal_maps_v2_large_ViT.png')
    ...
    # plt.subplots_adjust(wspace=0.1, hspace=0.1)
    plt.savefig('tusker_zebra_sal_maps_large_ViT.png')
    ...
    plt.savefig('dog_bird_sal_maps_large_ViT.png')