...
from ViT_new import deit_base_patch16_224 as vit_base_patch16_224
from ViT_LRP import deit_base_patch16_224 as vit_LRP
from ViT_orig_LRP import deit_base_patch16_224 as vit_orig_LRP
...
# Data
print("Testing DEiT on ImageNet segmentation", flush=True)
